    ...
    <div class='lg:max-w-7xl max-w-4xl grid items-start grid-cols-1 lg:grid-cols-2 gap-12'>
      <div>
        <form action="../../Backend/UploadPage/Upload.php" method="POST" enctype="multipart/form-data">
          ...
          <input type="text" name="invoiceID" id="invoiceID" class="w-full h-12 px-3 py-2 text-sm placeholder-gray-400 border rounded-lg" placeholder="<?php echo $invoiceID?>" value="<?php echo $invoiceID?>" />
