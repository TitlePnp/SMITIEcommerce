...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = getSellReportFilterByDate($start_date, $end_date);
} else {
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="hover:bg-gray-200">
                                        ...
                                        <td class="border border-gray-300 text-center px-3 py-4"><?php echo $TotalProfit ?> ฿</td>
                                        <td class="border border-gray-300 text-center px-3 py-4"><?php echo $TotalVat ?> ฿</td>
                                        <td class="border border-gray-300 text-center px-3 py-4"><?php echo $TotalCost ?> ฿</td>
                                        <td class="border border-gray-300 text-center px-3 py-4"><?php echo $TotalPrice ?> ฿</td>
                                    </tr>
                                <?php
                                }
                                ?>
