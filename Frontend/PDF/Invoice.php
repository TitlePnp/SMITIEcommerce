<?php
  ...
  include '../../Backend/Export/InvoiceDetail.php';
...
<body>		
  <div class="invoice-box">
    <table>
        ...
        <td colspan="5">
          <table>
            <tr>              
              ...
              <td class="right">
                <p class="bold">เลขที่เอกสาร: <span class="address"><?php echo $invoiceID ?></span></p>
                <p class="bold">วันที่ออก: <span class="address"><?php echo $row['StartDate'] ?></span></p>
                <p class="bold">วันครบกำหนด: <span class="address"><?php echo $row['EndDate'] ?></span></p>
              <?php } ?>
              </td>
            </tr>
          </table>
      ...
      <?php 
        $product = ProductDetail($invoiceID);
        $noVat = 0;
        $vat = 0;
        $total = 0;
	  ...
	  <tr class="item">
        <td>
          <div class="bold left"><?php echo $proName;?></div>
