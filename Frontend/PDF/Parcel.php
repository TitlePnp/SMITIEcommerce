...
//   require '../../Backend/Authorized/AdminAuthorized.php';
  include '../../Backend/Admin/Order/ReceiptList.php';
...
<body style="margin-right: 10%; margin-left: 10%;">		
  <div class="invoice-box">
    <table>
      <tr class="top">
		<td colspan="5">
		  <table style="border-bottom: 1px solid #ddd; border-radius: 10px;">
			<tr>
              <td class="left">
                <img src="../../Pictures/Admin/post.png" alt="logo" style="width: 30%;" />
              </td>
              <td class="right ;">
                <img src="../../Pictures/Admin/barcode.png" alt="logo" style="height: 10%; width: 100%;" />
                <p class="bold">Tracking No: <span class="address">MWE15230000072811</span></p>
              </td>
            </tr>
          </table>
        </td>
    ...
    <tr class="item">
      <td></td>
      <td></td>
      <td class="black">จำนวนเงินรวมทั้งสิ้น</td>
      <td></td>
